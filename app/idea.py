...
# **この境界は暫定。**原価の正本（seisan の material_cost）が第3段で入るまで
# 実測できない。画面に「暫定」と出し、`rubric.margin_bands` に持たせて
# あとから差し替えられるようにしてある。**推測値を確定値として出さない**（N-10）。
MARGIN_BANDS = [
    (4000, 10), (3000, 9), (2000, 8), (1600, 7), (1200, 6),
    (800, 5), (600, 4), (400, 3), (200, 2), (0, 1),
]
MARGIN_BANDS_NOTE = (
    "**暫定の境界です。**1個あたりの想定粗利額を1〜10点に写すための刻みで、"
    "根拠となる原価の正本（seisan の材料原価）は第3段で入ります。"
    "商品開発部の確認が取れるまで、この刻みは仮のものとして扱ってください。"
)
